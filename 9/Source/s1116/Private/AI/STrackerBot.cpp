...
{
    UGameplayStatics::ApplyDamage(this, 120.0f, GetInstigatorController(), this, nullptr);
}
//
//// Called every frame
void ASTrackerBot::Tick(float DeltaTime)
{
    ...
    if (Role == ROLE_Authority&&!bExploded)
    {
        ...
        {
            FVector ForceDirection = NextPathPoint - GetActorLocation();//add force to ai
            ForceDirection.Normalize();
            ForceDirection *= MovementForce;//force length
